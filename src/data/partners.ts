...
export const partners: Partner[] = [
  ...
  { id: 'tenax', name: 'Tenax Marcas', instagram: '@tenaxmarcas', sector: 'servicos', reach: 3, logo: '/partners/banners-site-tenax-200x120.png', description: 'Branding e gestão de marca, estratégia de posicionamento pra empresas que querem ser lembradas.' , whatsapp: '5551984488949'},
  ...
  { id: 'seibras', name: 'Seibras Estágios', instagram: '@seibrasestagios', sector: 'servicos', reach: 3, logo: '/partners/banners-site1-seibras-200x120.png', description: 'Agente de integração de estágios, conexão entre estudantes e empresas com toda a base legal cuidada.' , phone: '555132280744', whatsapp: '5551992876656'},
